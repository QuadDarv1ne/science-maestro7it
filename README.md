...
**Science Maestro7IT** — персональный научный портфельный сайт, демонстрирующий 38 научных публикаций автора с платформы Zenodo, 14 проектов с GitHub, а также профессиональную биографию. Реализован на Next.js 16 с TypeScript, Tailwind CSS 4 и shadcn/ui.
...
│   ├── data/
│   │   ├── publications.ts          # 38 публикаций Zenodo
...
|-----------|-----------|-------------|
| Образование | 17 | GitHub в образовании, гибридные модели, рефлексивное ИИ-ассистирование |
| ИИ и машинное обучение | 16 | Tesla FSD, федеративное обучение, ADAS, объяснимый ИИ |
| Социология и психология | 12 | Семья в цифровую эпоху, выгорание педагогов, одиночество |
| Информационная безопасность | 10 | Аномалии в КИС, фильтрация трафика, киберугрозы |
| Международные отношения | 9 | БРИКС, ШОС, гуаньси в кросс-культурном бизнесе |
...
Исходный код сайта предоставляется для ознакомления. Все материалы научных публикаций, тексты, графика и сопутствующие материалы защищены авторским правом Дуплей М.И.
